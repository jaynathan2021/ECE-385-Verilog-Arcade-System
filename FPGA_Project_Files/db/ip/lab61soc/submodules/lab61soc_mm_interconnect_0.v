...
module lab61soc_mm_interconnect_0 (
	...
	wire  [106:0] addr_s1_agent_rf_source_data;                                                       // Addr_s1_agent:rf_source_data -> Addr_s1_agent_rsp_fifo:in_data
	...
	wire  [106:0] addr_s1_agent_rsp_fifo_out_data;                                                    // Addr_s1_agent_rsp_fifo:out_data -> Addr_s1_agent:rf_sink_data
	...
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> Addr_s1_agent:cp_valid
	wire  [105:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> Addr_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // Addr_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [12:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> Addr_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> Addr_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> Addr_s1_agent:cp_endofpacket
	...
	wire   [12:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> key_s1_agent:cp_channel
	...
	wire  [105:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> hex_digits_pio_s1_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                              // hex_digits_pio_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [12:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> hex_digits_pio_s1_agent:cp_channel
	...
	wire   [12:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> usb_rst_s1_agent:cp_channel
	...
	wire   [12:0] cmd_mux_010_src_channel;                                                            // cmd_mux_010:src_channel -> usb_gpx_s1_agent:cp_channel
	...
	wire          cmd_mux_011_src_valid;                                                              // cmd_mux_011:src_valid -> usb_irq_s1_agent:cp_valid
	wire  [105:0] cmd_mux_011_src_data;                                                               // cmd_mux_011:src_data -> usb_irq_s1_agent:cp_data
	wire          cmd_mux_011_src_ready;                                                              // usb_irq_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire   [12:0] cmd_mux_011_src_channel;                                                            // cmd_mux_011:src_channel -> usb_irq_s1_agent:cp_channel
	wire          cmd_mux_011_src_startofpacket;                                                      // cmd_mux_011:src_startofpacket -> usb_irq_s1_agent:cp_startofpacket
	wire          cmd_mux_011_src_endofpacket;                                                        // cmd_mux_011:src_endofpacket -> usb_irq_s1_agent:cp_endofpacket
	...
	wire          addr_s1_agent_rp_valid;                                                             // Addr_s1_agent:rp_valid -> router_008:sink_valid
	wire  [105:0] addr_s1_agent_rp_data;                                                              // Addr_s1_agent:rp_data -> router_008:sink_data
	wire          addr_s1_agent_rp_ready;                                                             // router_008:sink_ready -> Addr_s1_agent:rp_ready
	wire          addr_s1_agent_rp_startofpacket;                                                     // Addr_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          addr_s1_agent_rp_endofpacket;                                                       // Addr_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire  [105:0] hex_digits_pio_s1_agent_rp_data;                                                    // hex_digits_pio_s1_agent:rp_data -> router_010:sink_data
	...
	wire          usb_irq_s1_agent_rp_valid;                                                          // usb_irq_s1_agent:rp_valid -> router_013:sink_valid
	wire  [105:0] usb_irq_s1_agent_rp_data;                                                           // usb_irq_s1_agent:rp_data -> router_013:sink_data
	wire          usb_irq_s1_agent_rp_ready;                                                          // router_013:sink_ready -> usb_irq_s1_agent:rp_ready
	wire          usb_irq_s1_agent_rp_startofpacket;                                                  // usb_irq_s1_agent:rp_startofpacket -> router_013:sink_startofpacket
	wire          usb_irq_s1_agent_rp_endofpacket;                                                    // usb_irq_s1_agent:rp_endofpacket -> router_013:sink_endofpacket
	...
	wire   [12:0] cmd_demux_001_src5_channel;                                                         // cmd_demux_001:src5_channel -> crosser_001:in_channel
	...
	wire   [12:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> rsp_mux_001:sink5_channel
	...
	wire          addr_s1_agent_rdata_fifo_src_valid;                                                 // Addr_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] addr_s1_agent_rdata_fifo_src_data;                                                  // Addr_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          addr_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_006:in_0_ready -> Addr_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> Addr_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> Addr_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // Addr_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> Addr_s1_agent:rdata_fifo_sink_error
	...
	wire          usb_irq_s1_agent_rdata_fifo_src_valid;                                              // usb_irq_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_011:in_0_valid
	wire   [33:0] usb_irq_s1_agent_rdata_fifo_src_data;                                               // usb_irq_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_011:in_0_data
	wire          usb_irq_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_011:in_0_ready -> usb_irq_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_011_out_0_valid;                                                  // avalon_st_adapter_011:out_0_valid -> usb_irq_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_011_out_0_data;                                                   // avalon_st_adapter_011:out_0_data -> usb_irq_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_011_out_0_ready;                                                  // usb_irq_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_011:out_0_ready
	wire    [0:0] avalon_st_adapter_011_out_0_error;                                                  // avalon_st_adapter_011:out_0_error -> usb_irq_s1_agent:rdata_fifo_sink_error
